...
public class LigacaoDistrito {
    ...
    public static void main(String args[]) {
        try (ZContext context = new ZContext()) {
            ...
            String distritos[] = {"Lisboa", "Porto", "Braga", "Setúbal", "Aveiro", "Faro", "Leiria", "Coimbra", "Santarém", "Viseu", "Madeira", "Acores", "Viana Do Castelo", "Vila Real", "Castelo Branco", "Évora", "Guarda", "Beja", "Bragança", "Portalegre"};
            ...
            replyer.connect("tcp://127.0.0.1:5555" + Integer.parseInt(input.readLine()));
